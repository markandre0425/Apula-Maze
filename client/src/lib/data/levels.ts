...
export const levels: GameLevel[] = [
  ...
  },
  {
    ...
    obstacles: [
      // Outer walls - thicker for better collision
      { x: 0, y: 0, width: 18, height: 1.5 }, // Top wall
      { x: 0, y: 17, width: 18, height: 1.5 }, // Bottom wall
      { x: 0, y: 0, width: 1.5, height: 18 }, // Left wall
      { x: 16.5, y: 0, width: 1.5, height: 18 }, // Right wall adjusted for thickness

      // Kitchen layout - counters and appliances with clear paths
      // Main island in center (reduced size)
      { x: 8, y: 7, width: 3, height: 3 },

      // Kitchen counters along walls with wider gaps
      { x: 1, y: 4, width: 3, height: 1 },  // Left counter 1
      { x: 1, y: 8, width: 2, height: 1 },  // Left counter 2
  ...
  },
  {
    ...
    obstacles: [
      ...
      // Main corridor - horizontal with central opening
      { x: 2, y: 9, width: 9, height: 1 }, // Upper corridor wall left
      { x: 14, y: 9, width: 9, height: 1 }, // Upper corridor wall right
      { x: 2, y: 12, width: 9, height: 1 }, // Lower corridor wall left
      { x: 14, y: 12, width: 9, height: 1 }, // Lower corridor wall right

      // Main corridor - vertical (intersects the horizontal)
      { x: 12, y: 1, width: 1, height: 7 }, // Upper vertical corridor
      { x: 12, y: 14, width: 1, height: 5 }, // Lower vertical corridor

      // Classrooms - Top section with doorways
      { x: 3, y: 3, width: 3, height: 1 }, // Top left classroom - top wall left
      { x: 7, y: 3, width: 3, height: 1 }, // Top left classroom - top wall right
      { x: 3, y: 7, width: 7, height: 1 }, // Top left classroom - bottom wall
      { x: 3, y: 3, width: 1, height: 4 }, // Top left classroom - left wall
      { x: 10, y: 3, width: 1, height: 2 }, // Top left classroom - right wall top
      { x: 10, y: 6, width: 1, height: 2 }, // Top left classroom - right wall bottom

      { x: 14, y: 3, width: 4, height: 1 }, // Top right classroom - top wall left
      { x: 19, y: 3, width: 4, height: 1 }, // Top right classroom - top wall right
      { x: 14, y: 7, width: 9, height: 1 }, // Top right classroom - bottom wall
      { x: 14, y: 3, width: 1, height: 2 }, // Top right classroom - left wall top
      { x: 14, y: 6, width: 1, height: 1 }, // Top right classroom - left wall bottom
      { x: 22, y: 3, width: 1, height: 5 }, // Top right classroom - right wall

      // Classrooms - Bottom section with doorways
      { x: 3, y: 14, width: 3, height: 1 }, // Bottom left classroom - top wall left
      { x: 7, y: 14, width: 3, height: 1 }, // Bottom left classroom - top wall right
      { x: 3, y: 18, width: 7, height: 1 }, // Bottom left classroom - bottom wall
      { x: 3, y: 14, width: 1, height: 4 }, // Bottom left classroom - left wall
      { x: 10, y: 14, width: 1, height: 2 }, // Bottom left classroom - right wall top
      { x: 10, y: 17, width: 1, height: 2 }, // Bottom left classroom - right wall bottom

      { x: 14, y: 14, width: 4, height: 1 }, // Bottom right classroom - top wall left
      { x: 19, y: 14, width: 4, height: 1 }, // Bottom right classroom - top wall right
      { x: 14, y: 18, width: 7, height: 1 }, // Bottom right classroom - bottom wall
      { x: 14, y: 14, width: 1, height: 2 }, // Bottom right classroom - left wall top
      { x: 14, y: 17, width: 1, height: 1 }, // Bottom right classroom - left wall bottom
  ...
  },
  {
    ...
    obstacles: [
      ...
      // Main corridors - horizontal (with gaps for passage)
      { x: 1, y: 5, width: 4, height: 1 },
      { x: 7, y: 5, width: 4, height: 1 },
      { x: 13, y: 5, width: 4, height: 1 },
      { x: 18, y: 5, width: 3, height: 1 },

      { x: 1, y: 11, width: 5, height: 1 },
      { x: 8, y: 11, width: 5, height: 1 },
      { x: 15, y: 11, width: 6, height: 1 },

      { x: 1, y: 17, width: 4, height: 1 },
      { x: 7, y: 17, width: 6, height: 1 },
      { x: 15, y: 17, width: 4, height: 1 },

      // Main corridors - vertical (with gaps for passage)
      { x: 5, y: 1, width: 1, height: 3 },
      { x: 5, y: 6, width: 1, height: 4 },
      { x: 5, y: 12, width: 1, height: 4 },
      { x: 5, y: 18, width: 1, height: 3 },

      { x: 11, y: 1, width: 1, height: 3 },
      { x: 11, y: 6, width: 1, height: 4 },
      { x: 11, y: 12, width: 1, height: 4 },
      { x: 11, y: 18, width: 1, height: 3 },

      { x: 17, y: 1, width: 1, height: 3 },
      { x: 17, y: 6, width: 1, height: 4 },
      { x: 17, y: 12, width: 1, height: 4 },
      { x: 17, y: 18, width: 1, height: 3 },

      // Office spaces and cubicles (with clear paths)
      { x: 2, y: 2, width: 2, height: 2 },
      { x: 7, y: 2, width: 2, height: 2 },
      { x: 13, y: 2, width: 2, height: 2 },
      { x: 18, y: 2, width: 2, height: 2 },

      { x: 2, y: 7, width: 2, height: 2 },
      { x: 8, y: 7, width: 2, height: 2 },
      { x: 14, y: 7, width: 2, height: 2 },
      { x: 19, y: 7, width: 1, height: 2 },

      { x: 2, y: 13, width: 2, height: 2 },
      { x: 8, y: 13, width: 2, height: 2 },
      { x: 14, y: 13, width: 2, height: 2 },
      { x: 19, y: 13, width: 1, height: 2 },

      { x: 3, y: 19, width: 1, height: 1 },
      { x: 8, y: 19, width: 2, height: 1 },
      { x: 13, y: 19, width: 2, height: 1 },
      { x: 18, y: 19, width: 2, height: 1 },
    ],
    completed: false,
    unlocked: false,
  },
  {
    ...
    obstacles: [
      ...
      // Simplified corridors with much wider gaps
      { x: 1, y: 7, width: 3, height: 1 },
      { x: 9, y: 7, width: 3, height: 1 },
      { x: 17, y: 7, width: 3, height: 1 },

      { x: 1, y: 15, width: 3, height: 1 },
      { x: 9, y: 15, width: 3, height: 1 },
      { x: 17, y: 15, width: 3, height: 1 },

      // Minimal vertical barriers
      { x: 7, y: 1, width: 1, height: 2 },
      { x: 7, y: 20, width: 1, height: 2 },

      { x: 15, y: 1, width: 1, height: 2 },
      { x: 15, y: 20, width: 1, height: 2 },

      // Patient room divisions and hospital sections
      // Top left quadrant (Emergency Room) with exits
      ...
      // Top center quadrant (Surgery) with exits
      { x: 9, y: 2, width: 2, height: 1 },
      { x: 12, y: 2, width: 2, height: 1 },
      { x: 9, y: 5, width: 2, height: 1 },
      { x: 12, y: 5, width: 1, height: 1 },

      // Top right quadrant (Intensive Care) with exits
      { x: 17, y: 3, width: 2, height: 1 },
      { x: 20, y: 3, width: 2, height: 1 },
      { x: 18, y: 5, width: 2, height: 1 },
      { x: 21, y: 5, width: 1, height: 1 },
      { x: 17, y: 1, width: 1, height: 2 },

      // Middle left quadrant (Pediatrics) with exits
      { x: 2, y: 9, width: 2, height: 1 },
      { x: 5, y: 9, width: 1, height: 1 },
      { x: 3, y: 11, width: 2, height: 1 },
      { x: 2, y: 13, width: 2, height: 1 },
      { x: 5, y: 13, width: 1, height: 1 },
      { x: 3, y: 9, width: 1, height: 2 },

      // Middle right quadrant (Laboratory) with exits
      { x: 17, y: 9, width: 2, height: 1 },
      { x: 20, y: 9, width: 2, height: 1 },
      { x: 18, y: 11, width: 2, height: 1 },
      { x: 21, y: 11, width: 1, height: 1 },
      { x: 17, y: 13, width: 2, height: 1 },
      { x: 20, y: 13, width: 1, height: 1 },
